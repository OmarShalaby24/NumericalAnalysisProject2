...
def methods_win(iter=50, errors=0.00001, initPoint=[0, 0, 0]):
    ...
    uknowns_label2 = Label(window, text="1.Enter number of equations", bg="#B7C3D0", fg="black")
    ...
    uknowns_label3 = Label(window, text="1.Enter number of equations", bg="#B7C3D0", fg="black")
    ...
    uknowns_label4 = Label(window, text="1.Enter number of equations", bg="#B7C3D0", fg="black")
